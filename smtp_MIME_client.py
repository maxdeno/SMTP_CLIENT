...
# create the email body(MIMEPART)
msg = MIMEMultipart()
msg["From"] = sender_email
msg["To"] = recipient_email
msg["Subject"] = "SMTP CLIENT TEST WITH MIME"
...
# Attach a body
image_path = r"C:\Users\Deno Max\Pictures\unnamed.png"

try:
    with open(image_path, "rb") as image_file:
        image_data = image_file.read()
        image_mime = MIMEImage(
            image_data, name=r"C:\Users\Deno Max\Pictures\unnamed.png")
        msg.attach(image_mime)

except FileNotFoundError:
    print("❌ image not found. Email will be sent without image")
